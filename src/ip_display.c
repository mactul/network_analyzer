...
const unsigned char* display_ipv4(const unsigned char* bytes, uint8_t* protocol)
{
...
const unsigned char* display_ipv6(const unsigned char* bytes, uint8_t* protocol)
{
...
const unsigned char* display_ip(const unsigned char* bytes, uint8_t* protocol)
{
    ...
    if(ip->version == 4)
    {
        return display_ipv4(bytes, protocol);
    }
    return display_ipv6(bytes, protocol);
}